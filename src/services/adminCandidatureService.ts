...
class AdminCandidatureService {
    async getCandidatsByConcours(concoursId: string | number): Promise<AdminCandidatureData> {
        const response = await apiService.makeRequest<any[]>(`/concours/${concoursId}/candidats`, 'GET');
        return {
